...
import 'user/app_user.dart' as _i8;
import 'user/notification.dart' as _i9;
import 'user/user_relation.dart' as _i10;
import 'user/user_request.dart' as _i11;
import 'protocol.dart' as _i12;
import 'package:flashlist_client/src/protocol/user/user_request.dart' as _i13;
import 'package:flashlist_client/src/protocol/user/app_user.dart' as _i14;
import 'package:flashlist_client/src/protocol/flashlist/flashlist.dart' as _i15;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.AppUser) {
      return _i8.AppUser.fromJson(data, this) as T;
    }
    if (t == _i9.Notification) {
      return _i9.Notification.fromJson(data, this) as T;
    }
    if (t == _i10.UserRelation) {
      return _i10.UserRelation.fromJson(data, this) as T;
    }
    if (t == _i11.UserRequest) {
      return _i11.UserRequest.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i8.AppUser?>()) {
      return (data != null ? _i8.AppUser.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i9.Notification?>()) {
      return (data != null ? _i9.Notification.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i10.UserRelation?>()) {
      return (data != null ? _i10.UserRelation.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i11.UserRequest?>()) {
      return (data != null ? _i11.UserRequest.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i12.FlashlistItem?>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i12.FlashlistItem?>(e))
              .toList()
          : null) as dynamic;
    }
    if (t == List<_i12.Flashlist>) {
      return (data as List).map((e) => deserialize<_i12.Flashlist>(e)).toList()
          as dynamic;
    }
    if (t == List<_i13.UserRequest?>) {
      return (data as List)
          .map((e) => deserialize<_i13.UserRequest?>(e))
          .toList() as dynamic;
    }
    ...
    if (t == List<_i15.Flashlist>) {
      return (data as List).map((e) => deserialize<_i15.Flashlist>(e)).toList()
          as dynamic;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i8.AppUser) {
      return 'AppUser';
    }
    if (data is _i9.Notification) {
      return 'Notification';
    }
    if (data is _i10.UserRelation) {
      return 'UserRelation';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'UserRelation') {
      return deserialize<_i10.UserRelation>(data['data']);
    }
