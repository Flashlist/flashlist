...
import 'flashlist/stream_messages/authors/remove_user_from_flashlist.dart'
    as _i8;
import 'flashlist/stream_messages/crud/delete_flashlist.dart' as _i9;
import 'flashlist/stream_messages/crud/flashlist_batch.dart' as _i10;
import 'flashlist/stream_messages/crud/update_flashlist.dart' as _i11;
import 'flashlist_item/flashlist_item.dart' as _i12;
import 'flashlist_item/stream_messages/delete_flashlist_item.dart' as _i13;
import 'flashlist_item/stream_messages/re_order_flashlist_item.dart' as _i14;
import 'user/app_user.dart' as _i15;
import 'user/notification.dart' as _i16;
import 'user/user_relation.dart' as _i17;
import 'user/user_request.dart' as _i18;
import 'protocol.dart' as _i19;
import 'package:flashlist_client/src/protocol/user/user_request.dart' as _i20;
import 'package:flashlist_client/src/protocol/user/app_user.dart' as _i21;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.RemoveUserFromFlashlist) {
      return _i8.RemoveUserFromFlashlist.fromJson(data, this) as T;
    }
    if (t == _i9.DeleteFlashlist) {
      return _i9.DeleteFlashlist.fromJson(data, this) as T;
    }
    if (t == _i10.FlashlistBatch) {
      return _i10.FlashlistBatch.fromJson(data, this) as T;
    }
    if (t == _i11.UpdateFlashlist) {
      return _i11.UpdateFlashlist.fromJson(data, this) as T;
    }
    if (t == _i12.FlashlistItem) {
      return _i12.FlashlistItem.fromJson(data, this) as T;
    }
    if (t == _i13.DeleteFlashlistItem) {
      return _i13.DeleteFlashlistItem.fromJson(data, this) as T;
    }
    if (t == _i14.ReOrderFlashlistItem) {
      return _i14.ReOrderFlashlistItem.fromJson(data, this) as T;
    }
    if (t == _i15.AppUser) {
      return _i15.AppUser.fromJson(data, this) as T;
    }
    if (t == _i16.Notification) {
      return _i16.Notification.fromJson(data, this) as T;
    }
    if (t == _i17.UserRelation) {
      return _i17.UserRelation.fromJson(data, this) as T;
    }
    if (t == _i18.UserRequest) {
      return _i18.UserRequest.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i8.RemoveUserFromFlashlist?>()) {
      return (data != null
          ? _i8.RemoveUserFromFlashlist.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i9.DeleteFlashlist?>()) {
      return (data != null ? _i9.DeleteFlashlist.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i10.FlashlistBatch?>()) {
      return (data != null ? _i10.FlashlistBatch.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i11.UpdateFlashlist?>()) {
      return (data != null ? _i11.UpdateFlashlist.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i12.FlashlistItem?>()) {
      return (data != null ? _i12.FlashlistItem.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i13.DeleteFlashlistItem?>()) {
      return (data != null
          ? _i13.DeleteFlashlistItem.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i14.ReOrderFlashlistItem?>()) {
      return (data != null
          ? _i14.ReOrderFlashlistItem.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i15.AppUser?>()) {
      return (data != null ? _i15.AppUser.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i16.Notification?>()) {
      return (data != null ? _i16.Notification.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i17.UserRelation?>()) {
      return (data != null ? _i17.UserRelation.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i18.UserRequest?>()) {
      return (data != null ? _i18.UserRequest.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i19.FlashlistItem?>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i19.FlashlistItem?>(e))
              .toList()
          : null) as dynamic;
    }
    ...
    if (t == List<_i20.UserRequest?>) {
      return (data as List)
          .map((e) => deserialize<_i20.UserRequest?>(e))
          .toList() as dynamic;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i8.RemoveUserFromFlashlist) {
      return 'RemoveUserFromFlashlist';
    }
    if (data is _i9.DeleteFlashlist) {
      return 'DeleteFlashlist';
    }
    if (data is _i10.FlashlistBatch) {
      return 'FlashlistBatch';
    }
    if (data is _i11.UpdateFlashlist) {
      return 'UpdateFlashlist';
    }
    if (data is _i12.FlashlistItem) {
      return 'FlashlistItem';
    }
    if (data is _i13.DeleteFlashlistItem) {
      return 'DeleteFlashlistItem';
    }
    if (data is _i14.ReOrderFlashlistItem) {
      return 'ReOrderFlashlistItem';
    }
    if (data is _i15.AppUser) {
      return 'AppUser';
    }
    if (data is _i16.Notification) {
      return 'Notification';
    }
    if (data is _i17.UserRelation) {
      return 'UserRelation';
    }
    if (data is _i18.UserRequest) {
      return 'UserRequest';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'RemoveUserFromFlashlist') {
      return deserialize<_i8.RemoveUserFromFlashlist>(data['data']);
    }
    if (data['className'] == 'DeleteFlashlist') {
      return deserialize<_i9.DeleteFlashlist>(data['data']);
    }
    if (data['className'] == 'FlashlistBatch') {
      return deserialize<_i10.FlashlistBatch>(data['data']);
    }
    if (data['className'] == 'UpdateFlashlist') {
      return deserialize<_i11.UpdateFlashlist>(data['data']);
    }
    if (data['className'] == 'FlashlistItem') {
      return deserialize<_i12.FlashlistItem>(data['data']);
    }
    if (data['className'] == 'DeleteFlashlistItem') {
      return deserialize<_i13.DeleteFlashlistItem>(data['data']);
    }
    if (data['className'] == 'ReOrderFlashlistItem') {
      return deserialize<_i14.ReOrderFlashlistItem>(data['data']);
    }
    ...
    if (data['className'] == 'UserRelation') {
      return deserialize<_i17.UserRelation>(data['data']);
    }
    if (data['className'] == 'UserRequest') {
      return deserialize<_i18.UserRequest>(data['data']);
    }
